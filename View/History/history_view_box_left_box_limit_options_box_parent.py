...
from View.History.history_view_box_left_box_limit_options_box import HistoryViewBoxLeftBoxLimitOptionsBox


class HistoryViewBoxLeftBoxLimitOptionsBoxParent(BoxLayout):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.dropdown = HistoryViewBoxLeftBoxLimitOptionsBox()
        self.dropdown_button = Button(text='LİMİT OPTİONS')
